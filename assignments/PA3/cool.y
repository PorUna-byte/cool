...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    void cool_yyerror(const char *s);        /*  defined below; called for each parse error */
    ...
    */
    ...
    /* The form of following is %type <constructor> non-terminal. */
    ...
    */
    ...
    | OBJECTID '(' formal dummy_formal_list ')' ':' TYPEID '{' expression '}'
    ...
    void cool_yyerror(const char *s)
    {
